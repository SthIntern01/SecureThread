...
import sandboxLogoLight from "../images/sandboxlogo-lightmode.png";
    ...
    <div className="min-h-screen w-full flex relative overflow-hidden bg-background">
      ...
      >
        {actualTheme === 'dark' ? (
          ...
          <IconMoon className="w-5 h-5 text-[#003D6B] group-hover:-rotate-12 transition-transform duration-300" />
        )}
      </button>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative z-10 overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute inset-0 bg-gradient-to-r from-[#003D6B]/20 to-transparent"></div>
          <div
            className="absolute inset-0"
            style={{
              backgroundImage: `radial-gradient(circle at 25% 25%, rgba(0,61,107,0.1) 1px, transparent 1px)`,
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-16">
          <div className="flex items-center space-x-3 mb-12">
            <img 
              src={actualTheme === 'dark' ? sandboxLogo : sandboxLogoLight}
              alt="Sandbox Logo" 
              className="w-70 h-20"
            />
          </div>
          <div className="mb-12">
            <h1 className="text-4xl xl:text-5xl font-bold leading-tight mb-6 text-[#1F2937] dark:text-white">
              One dashboard for risk, threat, and project security. 
            </h1>
          </div>
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              <div className="w-12 h-12 bg-[#B8D4E9]/40 dark:bg-orange-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                <IconLink className="w-6 h-6 text-[#003D6B] dark:text-orange-500" />
              </div>
              <div>
                ...
                <p className="text-[#6B7280] dark: text-gray-300 leading-relaxed">
                  Connect GitHub, GitLab, Bitbucket, and other repositories with one-click integration
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              <div className="w-12 h-12 bg-[#B8D4E9]/40 dark:bg-orange-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                <IconBolt className="w-6 h-6 text-[#003D6B] dark:text-orange-500" />
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2 text-[#1F2937] dark:text-white">
            ...
            <div className="flex items-start space-x-4">
              <div className="w-12 h-12 bg-[#B8D4E9]/40 dark:bg-orange-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                <IconTool className="w-6 h-6 text-[#003D6B] dark:text-orange-500" />
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2 text-[#1F2937] dark:text-white">
          ...
          <div className="mt-16 pt-8 border-t border-[#D1D5DB] dark:border-gray-700">
            <p className="text-sm text-[#9CA3AF] dark:text-gray-400 mb-4">
              Trusted by leading software companies
            </p>
            <div className="flex items-center space-x-6 opacity-60">
              <div className="text-xs font-medium text-[#6B7280] dark:text-gray-400">SOC 2</div>
              <div className="w-1 h-1 bg-[#9CA3AF] dark:bg-gray-500 rounded-full"></div>
              <div className="text-xs font-medium text-[#6B7280] dark:text-gray-400">ISO 27001</div>
              <div className="w-1 h-1 bg-[#9CA3AF] dark:bg-gray-500 rounded-full"></div>
              <div className="text-xs font-medium text-[#6B7280] dark:text-gray-400">GDPR Compliant</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative z-10">
        <div className="w-full max-w-md">
          ...
          <div className="space-y-4 mb-6">
            {/* GitHub Button - Solid dark with white text & icon */}
            <button
              onClick={handleGitHubLogin}
              disabled={loadingProvider !== null}
              className="w-full flex items-center justify-center space-x-3 py-4 px-6 bg-[#24292e] hover:bg-[#1a1e22] text-white font-semibold rounded-lg transition-all duration-300 shadow-md hover:shadow-lg disabled: opacity-50 disabled:cursor-not-allowed"
            >
            ...
            {/* Google Button - White with dark text & colored icon */}
            <button
              onClick={handleGoogleLogin}
              disabled={loadingProvider !== null}
              className="w-full flex items-center justify-center space-x-3 py-4 px-6 bg-white hover:bg-gray-50 text-[#1F2937] font-semibold rounded-lg border-2 border-[#D1D5DB] transition-all duration-300 shadow-md hover:shadow-lg disabled: opacity-50 disabled:cursor-not-allowed"
            >
            ...
            {/* GitLab Button - Solid coral with dark text & icon */}
            <button
              ...
              className="w-full flex items-center justify-center space-x-3 py-4 px-6 font-semibold rounded-lg transition-all duration-300 shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
              onMouseEnter={(e) => !loadingProvider && (e.currentTarget.style.backgroundColor = '#E85D1F')}
              onMouseLeave={(e) => !loadingProvider && (e.currentTarget.style.backgroundColor = '#FC6D26')}
            >
              <IconBrandGitlab className="w-5 h-5" style={{ color: '#FFFFFF' }} />
            ...
            {/* Bitbucket Button - Solid blue with white text & icon */}
            <button
              onClick={handleBitbucketLogin}
              disabled={loadingProvider !== null}
              className="w-full flex items-center justify-center space-x-3 py-4 px-6 bg-[#0052CC] hover:bg-[#0043A8] text-white font-semibold rounded-lg transition-all duration-300 shadow-md hover: shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                <path d="M0. 778 1.213a. 768.768 0 00-.768.892l3.263 19.81c.084.5.515.868 1.022.873H19.95a.772.772 0 00.77-.646l3.27-20.03a.768.768 0 00-.768-.891zM14.52 15.53H9.522L8.17 8.466h7.561z"/>
              </svg>
              <span>
          ...
          <div className="text-center mb-6">
            <p className="text-sm text-[#6B7280] dark: text-gray-400">
              ...
              <button
                ...
                className="text-[#FF6B35] dark:text-orange-500 hover:text-[#E55A2B] dark:hover:text-orange-400 font-medium transition-colors"
              >
                Enterprise SSO
              </button>{" "}
              |{" "}
          ...
          {/* Security Notice Box - FIXED: Better contrast */}
          <div className="bg-[#DBEAFE] dark:bg-blue-500/20 border-2 border-[#93C5FD] dark:border-blue-500/30 rounded-lg p-4 mb-6">
            <div className="flex items-start space-x-3">
              <IconShield className="w-5 h-5 text-[#1E40AF] dark:text-blue-300 mt-0.5 flex-shrink-0" />
              <div>
                <h4 className="font-semibold text-[#1E3A8A] dark:text-blue-100 text-sm">
                  Secure read-only access
                </h4>
                <p className="text-xs text-[#1E40AF] dark:text-blue-200 mt-1">
                  Our analysis does not require any agents, just read-only API access.  We never store your code. 
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center mb-6">
            <label className="flex items-center space-x-2 cursor-pointer">
              <input
                type="checkbox"
                className="w-4 h-4 text-[#003D6B] dark:text-orange-500 bg-white dark:bg-gray-700 border-2 border-[#D1D5DB] dark:border-gray-600 rounded focus:ring-[#003D6B] dark: focus:ring-orange-500 focus:ring-2"
              />
          ...
          <div className="text-center">
            <p className="text-xs text-[#6B7280] dark:text-gray-400 leading-relaxed">
              ...
              <a
                href="#"
                className="text-[#FF6B35] dark:text-orange-500 hover:text-[#E55A2B] dark:hover:text-orange-400 transition-colors"
              >
                Terms of Service
              </a>{" "}
              and{" "}
