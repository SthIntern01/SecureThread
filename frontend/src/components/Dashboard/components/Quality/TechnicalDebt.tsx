      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="text-center">
            ...
            <div className="text-white/60 text-sm">Total Effort</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-red-400 mb-1">
              ${Math.round(advancedDebt.totalDebtCost / 1000)}k
            </div>
            <div className="text-white/60 text-sm">Remediation Cost</div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <div className="text-white/60 text-sm">Sprint Impact</div>
            <div className="text-white font-medium">{advancedDebt.estimatedSprintImpact} sprints</div>
          </div>
        </div>
        ...
        {advancedDebt.slaBreachAnalysis && (
          <div>
            <div className="flex items-center mb-3">
              ...
              <span className="text-white font-medium">SLA Performance</span>
            </div>
            <div className="grid grid-cols-2 gap-3 text-sm">
              <div>
                <div className="text-white/60">Breaches</div>
              ...
              <div>
                <div className="text-white/60">Avg Age</div>
        ...
        {advancedDebt.roiOfFixing && (
          <div>
            <div className="flex items-center mb-3">
              ...
              <span className="text-white font-medium">ROI Analysis</span>
            </div>
        ...
        {advancedDebt.debtByAgeBucket && Object.keys(advancedDebt.debtByAgeBucket).length > 0 && (
          <div>
            <div className="flex items-center mb-3">
              ...
              <span className="text-white font-medium">Age Distribution</span>
            </div>
