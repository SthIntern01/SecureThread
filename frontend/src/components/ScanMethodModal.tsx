  ...
  return (
    <>
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="max-w-4xl p-0 overflow-hidden bg-gray-100/80 dark:bg-white/10 backdrop-blur-lg border border-white/20 shadow-2xl">
          {/* Custom Close Button */}
          <button
            onClick={onClose}
          ...
          <div className="px-8 py-6">
            <DialogHeader className="text-center mb-8">
              <DialogTitle className="text-3xl font-bold theme-text mb-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {/* Gen AI Scan Card */}
              <div className="bg-gray-100/80 dark:bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:border-orange-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-orange-500/10">
                <div className="text-center mb-6">
                  <div className="w-16 h-16 bg-orange-500 rounded-2xl flex items-center justify-center mx-auto mb-4">
                    <Zap className="w-8 h-8 theme-text" />
                  </div>
                  <h3 className="text-2xl font-bold theme-text mb-4">Gen AI Scan</h3>
                ...
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 theme-text font-semibold py-4 rounded-xl transition-all duration-200 hover:shadow-lg hover:shadow-orange-500/25 group"
                >
                  Get Started
              ...
              <div className="bg-gray-100/80 dark:bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:border-orange-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-orange-500/10">
                <div className="text-center mb-6">
                  <div className="w-16 h-16 bg-orange-500 rounded-2xl flex items-center justify-center mx-auto mb-4">
                    <Settings className="w-8 h-8 theme-text" />
                  </div>
                  <h3 className="text-2xl font-bold theme-text mb-4">Custom Scan</h3>
                  <p className="text-white/70 mb-6 leading-relaxed">
            ...
            <div className="text-center mt-8">
              <Button
                onClick={onClose}
                variant="ghost"
                className="text-white/70 hover:theme-text hover:bg-gray-100/80 dark:bg-white/10 transition-colors"
              >
                Cancel
              </Button>
            </div>
