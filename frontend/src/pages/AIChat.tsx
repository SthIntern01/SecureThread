        ...
        <div className="min-h-screen flex flex-col relative">
          ...
          <header className="flex justify-between items-center p-6 relative z-20">
            <div className="flex items-center gap-2">
              {/* UPDATED: Navy background in light mode, keep orange in dark */}
          ...
          <main className="flex-1 flex flex-col items-center justify-center px-4 text-center relative z-10 pb-20">
            <div className="max-w-4xl mx-auto space-y-8 w-full">
              {/* Badge - UPDATED: Navy accent in light mode */}
              <div className="flex justify-center">
                <div className="bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-700 rounded-full px-5 py-2.5 flex items-center gap-2 shadow-lg backdrop-blur-sm">
                  <span className="text-sm flex items-center gap-2 text-gray-800 dark:text-white font-medium">
                    {/* UPDATED: Navy background in light mode */}
                    <span className="bg-[#003D6B] dark:bg-orange-500 p-1.5 rounded-full text-white">🎉</span>
              ...
              <form onSubmit={handleSubmit} className="relative max-w-3xl mx-auto w-full mt-8">
                {/* UPDATED: Navy focus border in light mode */}
                <div className="bg-white dark: bg-gray-800 border-2 border-gray-300 dark:border-gray-700 rounded-2xl p-2 flex items-center gap-2 shadow-2xl backdrop-blur-sm transition-all duration-300 hover:shadow-3xl focus-within:border-[#003D6B] dark: focus-within:border-orange-500">
                  {/* Attachment Button */}
                  <button 
                    type="button"
                  ...
                  >
                    <Paperclip className="w-5 h-5 text-gray-600 dark:text-gray-400 group-hover:text-[#003D6B] dark:group-hover:text-orange-500 transition-colors" />
                  </button>

                  {/* AI Sparkles Button - UPDATED: Navy hover in light mode */}
                  <button 
                    type="button"
                    className="p-2.5 rounded-xl hover:bg-[#D6E6FF] dark:hover: bg-orange-50 dark:dark:hover:bg-orange-500/10 transition-all duration-200 group"
                  ...
                  {/* Send Button - UPDATED: Navy background in light mode */}
                  <button 
                    type="submit"
              ...
              {/* Suggestion pills - UPDATED:  Navy hover in light mode */}
