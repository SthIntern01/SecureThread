    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex items-center justify-center p-4">
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-8 max-w-md w-full text-center">
          ...
          <h2 className="text-xl font-semibold text-white mb-2">Loading Invitation...</h2>
          ...
          <div className="space-y-4 mb-6">
            <div className="bg-white/5 rounded-lg p-4 space-y-2">
              <div className="flex justify-between">
                ...
                <span className="text-white font-medium">{inviteDetails.team_name}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-white/70">Role:</span>
                <span className="text-white font-medium">{inviteDetails.role}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-white/70">Invited by:</span>
                <span className="text-white font-medium">{inviteDetails.invited_by}</span>
              </div>
              <div className="flex justify-between">
